...
const Signup = () => {
   ...
   return (
      <div className="flex items-center justify-center min-h-screen">
         <form onSubmit={loginSubmitHandler} className="md:p-8 max-w-md w-full rounded-lg md:border">
            <div className="mb-4">
               ...
               <div className="mb-4">
                  <div className="relative">
                     ...
                     {errors && <span className="text-red-500 text-sm">{errors.fullname}</span>}
                  </div>
               </div>
               <div className="mb-4">
                  <div className="relative">
                     ...
                     {errors && <span className="text-red-500 text-sm">{errors.email}</span>}
                  </div>
               </div>
               <div className="mb-4">
                  <div className="relative">
                     ...
                     {errors && <span className="text-red-500 text-sm">{errors.password}</span>}
                  </div>
               </div>
               <div className="mb-4">
                  <div className="relative">
                     ...
                     {errors && <span className="text-red-500 text-sm">{errors.contact}</span>}
                  </div>
               </div>
               <div className="mb-10">
                  {loading ? (
